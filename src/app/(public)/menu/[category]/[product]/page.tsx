    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-[#050505]">
        <div className="text-center">
          <h2 className="text-3xl font-serif italic text-amber-500/40 mb-4">Masterpiece Not Found</h2>
          <Link href="/menu" className="text-[10px] tracking-[0.4em] text-white/20 uppercase hover:text-amber-500 transition-colors">
            ← Back to Collection
          </Link>
        </div>
      </main>
